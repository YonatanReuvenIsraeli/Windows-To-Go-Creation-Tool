...
echo Step 5. Create on disk you want to install Windows on one NTFS partition that is greater than or is equal to 64GB, name it Windows and assign it an unused drive letter.
